...
The project is to experiment with the idea of using Pâte De Verre paste as a 3D printing medium. This can be done using extremely expensive machinery, but Alfie feel it is something that could be done in more affordable ways.
...
His experiments progressed, starting from puddles of molten glass up to more complex three dimensional pieces. He tried to keep the designs relatively simple at the start to not throw too many problems into the mix, but they are becoming increasingly complex as it progress.
